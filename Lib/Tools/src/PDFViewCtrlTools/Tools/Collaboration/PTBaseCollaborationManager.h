 ...
 * required.
 */
- (nullable NSString *)exportXFDFStringWithError:(NSError * _Nullable *)error;
 ...
 *
 * The notification object is the collaboration manager that posted the notification. The `userInfo` dictionary
 * contains entries for the `PTCollaborationManagerAnnotationUserInfoKey` key.
 */
PT_EXPORT const NSNotificationName PTCollaborationManagerRemoteAnnotationsAddedNotification;
 ...
 * contains entries for the `PTCollaborationManagerAnnotationUserInfoKey` key.
 */
PT_EXPORT const NSNotificationName PTCollaborationManagerRemoteAnnotationsModifiedNotification;
 ...
 * contains entries for the `PTCollaborationManagerAnnotationUserInfoKey` key.
 */
PT_EXPORT const NSNotificationName PTCollaborationManagerRemoteAnnotationsRemovedNotification;

#pragma mark - Notification user info keys

/**
 * The key for an `NSArray` of `PTCollaborationAnnotation` objects.
 */
PT_EXPORT NSString * const PTCollaborationManagerAnnotationsUserInfoKey;

/**
 * The key for an `NSNumber` object containing a `BOOL`.
 */
PT_EXPORT NSString * const PTCollaborationManagerIsInitialUserInfoKey;

 ...
 */
@property (nonatomic, strong, nullable, readonly) PTExternalAnnotManager* externalAnnotManager;
 ...
 *
 * The notification object is the pdfViewCtrl that posted the notification. The `userInfo` dictionary
 * contains entries for the `PTPDFViewCtrlColorPostProcessModeUserInfoKey` and
 * `PTPDFViewCtrlPageNumberUserInfoKey` keys. It may also contain entries for the
 * `PTPDFViewCtrlWhiteColorUserInfoKey` and `PTPDFViewCtrlBlackColorUserInfoKey` keys when the
 * post-process colors are changed with `-SetColorPostProcessColors:black_color:`.
 */
FOUNDATION_EXPORT const NSNotificationName PTPDFViewCtrlColorPostProcessModeDidChangeNotification;
 ...
 * presentation mode.
*/
FOUNDATION_EXPORT const NSNotificationName PTPDFViewCtrlPagePresentationModeDidChangeNotification;
 ...
 */
FOUNDATION_EXPORT NSString * const PTPDFViewCtrlStreamingEventMessageUserInfoKey;

/**
 * The key for a `NSNumber` object containing a PTColorPostProcessMode.
 */
FOUNDATION_EXPORT NSString * const PTPDFViewCtrlColorPostProcessModeUserInfoKey;

/**
 * The key for a `UIColor` object containing the color that black is mapped to.
 */
FOUNDATION_EXPORT NSString * const PTPDFViewCtrlBlackColorUserInfoKey;

/**
 * The key for a `UIColor` object containing the color that white is mapped to.
 */
FOUNDATION_EXPORT NSString * const PTPDFViewCtrlWhiteColorUserInfoKey;

/**
 * The key for a `NSNumber` object containing a `TrnPagePresentationMode`.
 */
FOUNDATION_EXPORT NSString * const PTPDFViewCtrlPagePresentationModeUserInfoKey;
